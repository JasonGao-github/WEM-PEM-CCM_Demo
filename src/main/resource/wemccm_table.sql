...
CREATE TABLE `negotiatedconnection`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inquiryNumber` varchar(255) ,
  `maximumAllocatedCapacity` varchar(512) ,
  `minimumContractDemandPrimary` varchar(512) ,
  `scopeofWorksCustomerFunded` varchar(512) ,
  `scopeofWorksJemenaFunded` varchar(512) ,
  `exclusions` varchar(512) ,
  `assumptions` varchar(512) ,
  `supplyAddress` varchar(512) ,
  `projectReference` varchar(512) ,
  `jemenaResponsibleOfficer` varchar(512) ,
  `date` datetime NULL DEFAULT NULL,
  `minimumContractDemandReserveFeeder` varchar(512) ,
  `validityPeriod` varchar(512) ,
  `plannedConstructionPeriod` varchar(512) ,
  `nominalSupplyVoltage` varchar(512) ,
  `supplyPhasing` varchar(512) ,
  `embeddedNetwork` varchar(512) ,
  `interestrateforoverduepayment` varchar(512) ,
  `Security` varchar(512) ,
  `connectionAssetandConnectionPointLocation` varchar(512) ,
  `premisesConnectionAssetsandPartiesResponsibleforInstallation` varchar(512) ,
  `statutoryorOtherApprovalstobeobtainedbyJemena` varchar(512) ,
  `leaseorEasementRequired` varchar(512) ,
  `customerResponsibleOfficer` varchar(512) ,
  `companyTradingName` varchar(512) ,
  `ABN` varchar(512) ,
  `networkExtensionorAugmentation` varchar(512) ,
  `projectId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ;
...
CREATE TABLE `customercontribution`  (
  ...
  `projectTitle` varchar(128)  NULL DEFAULT NULL,
  `projectType` varchar(128) NULL DEFAULT NULL,
  `supplyAddress` varchar(128)  NULL DEFAULT NULL,
  `customerReasonForWorks` varchar(512)  NULL DEFAULT NULL,
  `customerScopeOfWork` varchar(512)  NULL DEFAULT NULL,
  `jemenaScopeOfWork` varchar(512)  NULL DEFAULT NULL,
  `jemenaScopeExclusions` varchar(512)  NULL DEFAULT NULL,
  `assumption` varchar(512)  NULL DEFAULT NULL,
