...
import com.wemccm.project.service.FIMInputDataService;
	...
	@RestController
	@RequestMapping("/ConnectionHandover")
	public class ConnectionHandoverDataController {

		@Autowired
		private ConnectionHandoverDataService qiService;

		@RequestMapping(value = "/getData", produces = "application/json;charset=UTF-8")
		public ConnectionHandoverDataPojo getData() {
