...
<body ng-app="main_app" id="main" ng-controller="controller" ng-init="get_ncc()">
			...
			<div class="container content d-flex flex-column">
				...
				<form class="form container" name="newUser" action="" method="POST"
					...
					<div class="other">
						...
						<div ng-repeat="itm in ncc_itms">
							<div class="row light">
								<h4 class="col-4">{{itm.title}}</h4>
						...
						<div class="row light">
							<h4 class="col-4">Constrution Quality Audits (4 staged
								audit)</h4>
