				...
				<div class="row">
					<div class="col-12">
						<ul class="nav nav-pills"
							...
							<li class="nav-item"><a class="nav-link" href="project_page">Project
									Home</a></li>
							...
							<li class="nav-item"><a class="nav-link" href="#">Approvers</a>
							</li>
						</ul>
					</div>
				</div>
						...
						<div class="card shadow mb-4" style="border-radius: 15px">
							<div class="card-body">
								...
								<form class="form container" style="justify-content: center">
										...
										<tbody>
											...
											<tr>
												<td>Contractor Management and Administration Costs
													(applicable to contestability)</td>
												<td></td>
												<td></td>
												<td></td>
											</tr>
											...
											<tr>
												<td>Customer initiated undergrounding and/or
													rearrangement of distribution assets servicing the customer</td>
												<td></td>
												<td></td>
												<td></td>
											</tr>
											...
											<tr>
												<td>Less JEN's avoided cost as a result of customer
													initated undergrounding/relocation of distribution assets</td>
												<td></td>
												<td></td>
												<td></td>
											</tr>
									...
									<p>NOTE: This model is not required for Basic Connection Services (new connections below 100A/400V supply, basic alterations or basic micro-embedded generation connections). Refer to Jemena's Connection Policy for further details</p>
